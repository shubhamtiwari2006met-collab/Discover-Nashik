            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2 rounded-2xl border border-[#d8c4a3] bg-white p-5 shadow-sm">
                <PhotoInput
                  ...
                  description={t("Provide a photo of your business using camera, device, or web URL.")}
                  value={uploadedPreviewUrl || form.photos}
                  onChange={(val) => {
                    setUploadedPreviewUrl(val);
                    updateField("photos", val);
                  }}
                />
              </div>
            </div>
