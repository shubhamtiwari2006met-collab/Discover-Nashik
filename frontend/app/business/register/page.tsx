...
import { Loader2, ArrowLeft, Building2, UploadCloud, CheckCircle2, Clock, MapPin, Globe, Phone, Mail, User } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t border-[#e1cfb0] pt-6">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <label className="block text-sm font-semibold text-[#173247] sm:col-span-2">
                Business Photo URLs *
                <span className="mt-1 block text-xs font-normal text-[#667883]">
                  Enter image URLs (one per line). Example: https://images.unsplash.com/photo-1555396273-367ea4eb4db5
                </span>
                <textarea
                  required
                  rows={3}
